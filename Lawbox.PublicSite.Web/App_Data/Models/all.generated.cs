...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "a588867cf468961d")]
...
#pragma warning restore 0109
		...
		///<summary>
		/// Page Title: The title of the page, this is also the first text in a ogle search result. The ideal length is between 40 and 60 characters
		///</summary>
...
#pragma warning restore 0109
		...
		///<summary>
		/// Lo: Optional. If you add a lo it'll be used in the upper left corner instead of the site name. Make sure to use a transparent lo for best results
		///</summary>
		[ImplementPropertyType("SiteLo")]
		public IPublishedContent SiteLo
		{
			get { return this.GetPropertyValue<IPublishedContent>("SiteLo"); }
		}
...
#pragma warning restore 0109
		...
		///<summary>
		/// Description: A brief description of the content on your page. This text is shown below the title in a ogle search result and also used for Social Sharing Cards. The ideal length is between 130 and 155 characters
		///</summary>
...
#pragma warning restore 0109
		...
		/// Cateries (tags)
		///</summary>
		[ImplementPropertyType("cateries")]
		public IEnumerable<string> Cateries
		{
			get { return this.GetPropertyValue<IEnumerable<string>>("cateries"); }
		}
...
#pragma warning restore 0109
		...
		///<summary>
		/// ApiKey: To use the map you'll need your own ogle API key. More information here: https://developers.ogle.com/maps/documentation/javascript/error-messages#no-api-keys
		///</summary>
...
#pragma warning restore 0109
		...
		/// Catery
		///</summary>
		[ImplementPropertyType("catery")]
		public IEnumerable<string> Catery
		{
			get { return this.GetPropertyValue<IEnumerable<string>>("catery"); }
		}
